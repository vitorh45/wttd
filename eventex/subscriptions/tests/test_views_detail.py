...
class DetailTest(TestCase):
	def setUp(self):
		s = Subscription.objects.create(name='Vitor Hugo Campos', cpf='12345678901',
		email='vitorh45@gmail.com', phone='19-999350909')
	...
	def test_html(self):
		...
		self.assertContains(self.resp, 'Vitor Hugo Campos')
